...
namespace Flat.Graphics
{
    public sealed class Camera
    {
        ...
        public Vector2 Position //dá acesso ao usuário
        {
        ...
        public void IncZoom() //increment zoom
        {
            this.zoom++;
            this.zoom = Util.Clamp(this.zoom, Camera.MinZoom, Camera.MaxZoom);
            this.z = this.baseZ / zoom;
        }
        public void DecZoom() //decrement zoom
        {
            this.zoom--;
            this.zoom = Util.Clamp(this.zoom, Camera.MinZoom, Camera.MaxZoom);
            this.z = this.baseZ / zoom;
        ...
        public void GetExtents(out Vector2 min, out Vector2 max) // de um canto ao outro da tela
        {
